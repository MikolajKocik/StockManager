...
public sealed class MarkShipmentAsReturnedCommandHandler(
        IShipmentRepository repository,
        ILogger<MarkShipmentAsReturnedCommandHandler> logger,
        IShipmentService shipmentService,
        IUnitOfWork uow
    ) : ICommandHandler<MarkShipmentAsReturnedCommand, Unit>
{
    ...
    private readonly ILogger<MarkShipmentAsReturnedCommandHandler> _logger = logger;
