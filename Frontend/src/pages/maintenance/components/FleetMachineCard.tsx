        ...
        >
            <div className="flex items-center justify-between gap-1 mb-2">
                <div className="flex items-center gap-1.5">
                    <span className="font-mono font-bold text-xs bg-slate-800 text-white px-1.5 py-0.5 rounded-xs shadow-2xs">
                        {machine.code}
                    </span>
            ...
            <figure className="w-full h-24 bg-slate-50 border border-slate-200 rounded flex items-center justify-center p-1.5 overflow-hidden relative">
                <img
                    src={machine.image}
                    alt={machine.name}
            ...
            <div className="mt-2 space-y-1.5">
                ...
                <div className="flex items-center justify-between text-xs text-slate-500 font-mono">
                    <span className="truncate max-w-[6.875rem]" title={machine.assignedOperator || 'Unassigned'}>
                ...
                <progress
                    ...
                    max={100}
                    className="w-full h-1.5 rounded accent-emerald-600"
                />
            </div>
        </article>
    );
