        ...
        <div className="bg-white border border-slate-300 rounded-lg p-3 shadow-xs space-y-4">
            <div>
                <h3 className="font-bold text-xs text-slate-800 uppercase tracking-wider mb-2 flex items-center justify-between">
                    ...
                    <span className="text-[0.625rem] text-slate-400 font-mono font-normal">Click to insert</span>
                </h3>
                <p className="text-[0.6875rem] text-slate-500 mb-3">
            ...
            <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                    ...
                    >
                        ...
                        <span className="text-[0.625rem] text-slate-500 block">Pallet & SSCC standard</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-[0.625rem] text-slate-500 block">GS1 13-digit product code</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-[0.625rem] text-slate-500 block">Autonomous AMR scan</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-[0.625rem] text-slate-500 block">Bin rack alphanumeric</span>
                    </button>
                </div>
            </div>
            ...
            <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-1.5 text-xs">
                    <button
                        ...
                        className="text-left p-1.5 rounded border border-slate-200 hover:border-slate-800 hover:bg-slate-50 text-[0.6875rem] font-medium text-slate-800 cursor-pointer"
                    >
                        + Product Name
                    </button>
