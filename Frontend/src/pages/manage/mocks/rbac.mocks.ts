...
export const INITIAL_ROLE_PERMISSIONS: RolePermissionMatrix[] = [
    ...
    {
        roleId: 'ROLE_FOREMAN',
        roleName: 'Shift Foreman / Brygadzista',
        roleDescription: 'Supervises floor operations, ramp slots and emergency barcodes',
        userCount: 6,
    ...
    },
    {
        ...
        roleName: 'High-Reach Forklift Operator / Wózkowy',
    ...
    {
        roleId: 'ROLE_PICKER',
        roleName: 'Order Picker / Kompletator',
