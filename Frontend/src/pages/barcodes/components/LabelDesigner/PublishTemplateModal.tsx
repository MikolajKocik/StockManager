            ...
            <div className="bg-white border border-slate-300 rounded-lg shadow-2xl max-w-xl w-full overflow-hidden text-slate-800 animate-scale-in">
                ...
                <div className="bg-[#384155] text-white px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <span className="bg-emerald-400 text-slate-950 text-[10px] font-black px-2 py-0.5 rounded font-mono uppercase">
                ...
                <div className="p-4 space-y-3 text-xs">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 space-y-2.5">
                        <div className="flex items-center justify-between border-b border-slate-200 pb-2">
                            <div>
                                <span className="text-[10px] font-bold text-slate-500 uppercase block">Template Name</span>
                        ...
                        <div className="grid grid-cols-3 gap-2 text-xs">
                            ...
                            <div>
                                <span className="text-slate-500 block text-[10px]">Configured Items:</span>
                                <span className="font-semibold text-slate-800">
                    ...
                    <div className="pt-1 border-t border-slate-200">
                        ...
                        {showTechnicalDetails && (
                            <div className="mt-2 space-y-1.5 animate-fade-in">
                                <pre className="bg-slate-900 text-slate-100 p-2.5 rounded text-[10px] font-mono overflow-auto max-h-48 border border-slate-700">
                                    {jsonString}
                                </pre>
                            </div>
                        )}
