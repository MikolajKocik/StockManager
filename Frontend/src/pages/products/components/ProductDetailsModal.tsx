...
export const ProductDetailsModal: React.FC<ProductDetailsModalProps> = ({ productId, isOpen, onClose }) => {
                        ...
                        {activeTab === 'overview' && (
                            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{product.supplierName} (ID: {product.supplierId})</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Batch Number</p>
                                    <p className="font-medium">{product.batchNumber || 'N/A'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Expiration Date</p>
                                    <p className="font-medium">{product.expirationDate || 'N/A'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Delivered At</p>
                                    <p className="font-medium">{product.deliveredAt || 'N/A'}</p>
                                </div>
                            </div>
                        )}
