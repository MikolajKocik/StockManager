                            ...
                            <TableRow key={customer.id}>
                                ...
                                <TableCell>
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[0.625rem] text-slate-500 truncate max-w-48">
                                ...
                                {/* Segment */}
                                <TableCell>
                                    <span className="font-semibold font-mono text-[0.6875rem] text-slate-700 bg-slate-100 border border-slate-300 px-1.5 py-0.5 rounded-xs">
                                ...
                                <TableCell>
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[0.625rem] text-slate-600 font-medium font-mono">
                                ...
                                {/* Status */}
                                <TableCell>
                                    <span className={`inline-flex items-center gap-1.5 text-xs font-semibold ${statusConfig.textClass}`}>
