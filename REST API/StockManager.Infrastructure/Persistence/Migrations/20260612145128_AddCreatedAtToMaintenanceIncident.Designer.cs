...
namespace StockManager.Infrastructure.Migrations
{
    ...
    [Migration("20260612145128_AddCreatedAtToMaintenanceIncident")]
    partial class AddCreatedAtToMaintenanceIncident
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockManager.Core.Domain.Models.StockTransactionEntity.StockTransaction", b =>
                {
                    ...
                    b.HasIndex("InventoryItemId", "Type", "Date", "ReferenceNumber", "SourceLocationId", "TargetLocationId")
                        .IsUnique()
                        .HasDatabaseName("UX_StockTransaction_BusinessKey")
                        .HasFilter("[SourceLocationId] IS NOT NULL AND [TargetLocationId] IS NOT NULL");
